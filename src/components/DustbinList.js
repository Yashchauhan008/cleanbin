...
//     try {
//       const response = await axios.get('http://localhost:5000/dustbins');
...
//     e.preventDefault();
//     try {
//       const response = await axios.post('http://localhost:5000/dustbins/add', newDustbin);
...
//     e.preventDefault();
//     try {
//       const response = await axios.put(`http://localhost:5000/dustbins/edit/${editDustbinId}`, newDustbin);
...
//     try {
//       await axios.delete(`http://localhost:5000/dustbins/delete/${id}`);
